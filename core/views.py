...
TEXTS = {
    'pt': {
        ...
        'contact_sub': 'Disponível para projetos via UpWork & Freelancer',
        'contact_upwork': '📢 Estou disponível para novos projetos via <strong>UpWork & Freelancer</strong>. Se você precisa de um desenvolvedor Django, automação de redes ou aplicações web completas, entre em contato!',
        'work_label': 'Processo',
        'work_title': 'Modelo de Trabalho',
        'work_sub': 'Como transformo sua ideia em solução',
        'work_1_title': 'Levantamento',
        'work_1_desc': 'Entendimento do problema, definição de requisitos, prototipação e alinhamento de expectativas.',
        'work_1_time': 'Semana 1',
        'work_2_title': 'Arquitetura',
        'work_2_desc': 'Modelagem de dados, definição de stack, estrutura do projeto e configuração de ambiente.',
        'work_2_time': 'Semana 1',
        'work_3_title': 'Codificação',
        'work_3_desc': 'Desenvolvimento ágil com entregas incrementais, testes e code review.',
        'work_3_time': 'Semana 2-3',
        'work_4_title': 'Entrega',
        'work_4_desc': 'Deploy, documentação, treinamento e suporte pós-entrega.',
        'work_4_time': 'Semana 3-4',
    ...
    'en': {
        ...
        'contact_sub': 'Available for projects via UpWork & Freelancer',
        'contact_upwork': '📢 I\'m available for new projects on <strong>UpWork & Freelancer</strong>. If you need a Django developer, network automation or full web applications, get in touch!',
        'work_label': 'Process',
        'work_title': 'Work Process',
        'work_sub': 'How I turn your idea into a solution',
        'work_1_title': 'Discovery',
        'work_1_desc': 'Problem understanding, requirements gathering, prototyping and expectation alignment.',
        'work_1_time': 'Week 1',
        'work_2_title': 'Architecture',
        'work_2_desc': 'Data modeling, stack definition, project structure and environment setup.',
        'work_2_time': 'Week 1',
        'work_3_title': 'Development',
        'work_3_desc': 'Agile development with incremental deliveries, testing and code review.',
        'work_3_time': 'Week 2-3',
        'work_4_title': 'Delivery',
        'work_4_desc': 'Deploy, documentation, training and post-delivery support.',
        'work_4_time': 'Week 3-4',
